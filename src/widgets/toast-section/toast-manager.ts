import { useToastManager, createToastManager } from '@/shared/ui/components/toast';

export type ToastType = 'info' | 'warning' | 'error' | 'success' | 'loading';

const baseToastManager = createToastManager();

function add<Data extends object>(
	options: useToastManager.AddOptions<Data> & { type: ToastType }
) {
